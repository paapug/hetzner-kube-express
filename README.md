...
### 🔑 SigNoz admin password

The first-apply password is generated by Terraform and seeded into the cluster. It is also mirrored to R2 at `secrets/<env>/signoz.json`.
