...
variable "r2_secrets_key" {
  type        = string
  description = "Object key (within r2_bucket) for the JSON-encoded secrets blob. Expected keys: hcloud_token, ssh_public_key, ssh_private_key, firewall_ssh_source, firewall_kube_api_source."
}
